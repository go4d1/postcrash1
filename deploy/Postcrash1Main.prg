...
***            Postcrash1.exe "config"
***            Postcrash1.exe "config" "IIS://localhost/w3svc/21/root"
************************************************************************
...
IF VARTYPE(lcAction) = "C" AND StartsWith(LOWER(lcAction),"config")
         do Postcrash1_ServerConfig.prg with lvParm1
      RETURN 
ENDIF

*** Load the server - wc3DemoServer class below
goWCServer = CREATE("Postcrash1Server")
...
IF llAutoRestart
   LiveReloadShutdown("DO Postcrash1Main.prg")
ELSE
...
**************************************************************
DEFINE CLASS Postcrash1Server AS WWC_SERVER OLEPUBLIC
*************************************************************
...
*** THIS.cAppIniFile = addbs(THIS.cAppStartPath) + "Postcrash1.ini"

THIS.cAppName = "Postcrash1"
THIS.cAppIniFile = addbs(THIS.cAppStartPath) + "Postcrash1.ini"
...
THIS.oConfig = CREATEOBJECT("Postcrash1Config")
...
************************************************************************
*  Postcrash1Server :: OnInitCompleted
****************************************
...
***************************************************************
DEFINE CLASS Postcrash1Config AS wwServerConfig
***************************************************************
*: Author: Rick Strahl
...
ENDDEFINE
*EOC Postcrash1Config


DEFINE CLASS wwMaintConfig as RELATION

cHTMLPagePath = "c:\WebConnectionProjects\PostCrash1\Web\"
cDATAPath = ".\"
cVirtualPath = "/PostCrash1/"
