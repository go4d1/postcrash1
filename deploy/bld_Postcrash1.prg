...
EXE_FILE		  =		  	"Postcrash1"
DCOM_ProgId       =			"Postcrash1.Postcrash1Server"
DCOM_UserId		  =			"Interactive User"

*** Server Update Urls - fix these to point at your production Server/Virtual
HTTP_UPLOADURL    =         "http://localhost/Postcrash1/UploadExe.wc"
HTTP_UPDATEURL 	  =         "http://localhost/Postcrash1/UpdateExe.wc"

*** for ISAPI use this url
* HTTP_UPLOADURL    =         "http://localhost/Postcrash1/wc.wc?wwmaint~FileUpload"
