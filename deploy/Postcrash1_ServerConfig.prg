...
***            Postcrash1.ini and you can customize operation there.
***
***            [ServerConfig]
***            Virtual=Postcrash1            
***            ScriptMaps=wc,wcs,wcsx,ctd    
...
***
***    Assume: Called from Postcrash1Main.prg startup code
***            with lcAction parameter:
***            DO Postcrash1Main with "CONFIG"
***
***            Or launch your Exe from the Windows Command Line:
***            Postcrash1.exe config
***
***            or with a specific IIS site/virtual
***            Postcrash1.exe config "IIS://localhost/w3svc/12/root"
***
...
lcAppName = "Postcrash1"
lcDefaultVirtual = "PostCrash1"
lcScriptMap = "ctd"
...
*** Try to read from Postcrash1.ini [ServerConfig] section
